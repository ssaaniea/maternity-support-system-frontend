...
class _DoctorDetailsScreenState extends State<DoctorDetailsScreen> {
  ...
  double _calculateTotal() {
    ...
    final pricePerDay = (widget.doctor['amount'] as num).toDouble();
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow(
                    Iconsax.hospital,
                    "Hospital name",
                    "${c['hospital_id']['hospital_name']}",
                  ),
                  const SizedBox(height: 12),
                  _buildDetailRow(
                    Iconsax.call,
                    "Contact",
                    "${c['hospital_id']['phone_number']}",
                  ),
                  const SizedBox(height: 12),
                  _buildDetailRow(
                    Iconsax.location,
                    "Type",
                    c['hospital_id']['hospital_type'] ?? '-',
                  ),
                  const SizedBox(height: 12),
                  _buildDetailRow(
                    Iconsax.map_1,
